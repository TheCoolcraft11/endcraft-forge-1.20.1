...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<OculusOreProjectile>> OCULUS_ORE_PROJECTILE  = ENTITY_TYPES.register("oculus_ore_projectile", () -> EntityType.Builder.<OculusOreProjectile>of(OculusOreProjectile::new, MobCategory.MISC).sized(0.5f, 0.5f).build("void_ghost"));
